...
router.post('/add', async(req, res) => {
  ...
  try {
    ...
    if(body.password < Enum.PASS_LENGHT) throw new CustomError(Enum.HTTP_CODES.BAD_REQUEST, "Validation Error", "Password lenght must be greater than "+ Enum.PASS_LENGHT +" characters");
    ...
    let password = bcrypt.hashSync(body.password, bcrypt.genSaltSync(8), null); // Hash the password
...
router.post('/update', async(req, res) => {
  try {
    ...
    if(!body._id) throw new CustomError(Enum.HTTP_CODES.BAD_REQUEST, "Validation Error", "User ID is required: _id field must be filled");
